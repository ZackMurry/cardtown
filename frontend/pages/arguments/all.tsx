  ...
  return (
    ...
    >
      ...
      <div style={{ marginLeft: width >= theme.breakpoints.values.lg ? '12.9vw' : 0, paddingLeft: 38, paddingRight: 38 }}>
        ...
        <BlackText style={{ fontSize: 24, fontWeight: 'bold' }}>All arguments</BlackText>
        <div
          style={{
            width: '100%',
            margin: '2vh 0',
          ...
          <Grid container>
            <Grid item lg={9} style={{ paddingLeft: 20 }}>
              <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                >
                  <BlackText style={{ fontWeight: 500 }}>Name</BlackText>
                </button>
                {sort.by === 'name' && (
            ...
            <Grid item lg={3} style={{ marginLeft: -10 }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                >
                  <BlackText style={{ fontWeight: 500 }}>Number of cards</BlackText>
                </button>
                {sort.by === 'cards' && (
                  <div className={styles['icon-container'] + ' ' + (sort.ascending && styles['icon-container-180'])}>
                    <IconButton
