...
const LandingPageMobileHero: FC<Props> = ({ tilesSectionRef }) => (
  ...
  >
    <Heading variant='h1' width='100%' padding='0 5%' textAlign='center' fontSize='36px' fontWeight='400px'>
      The hub for your <span style={{ color: theme.palette.primary.main }}>debate cards</span>
    </Heading>
    <Heading as='h5' margin='25px auto' width='90%' textAlign='center' fontWeight='300' fontSize='18px'>
    ...
    <Box marginTop='3vh' display='flex' flexDir='column' alignItems='center'>
